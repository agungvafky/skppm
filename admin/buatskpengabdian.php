  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
       ...
       <div class="card mb-3">
          <div class="card-header">
            <a href="pengajuanskpengabdian.php"><i class="fas fa-arrow-left"></i> Back</a>
          </div>
          <div class="card-body">
            <?php
        include "koneksi.php";
        ...
        if(isset($_POST['simpan']))
      {
        ...
        $cekdata = mysqli_query($koneksi,"select * from skpengabdian where no_surat='$no_surat'");
        ...
        else
        {
         ...
         //seleksi data dari data base
      mysqli_query($koneksi,"insert into skpengabdian values
            ('',
            '$no_surat',
            '$nidn',
            '$judul',
