    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
       ...
       <div class="card mb-3">
          <div class="card-header">
            <a href="skpenelitian.php"><i class="fas fa-arrow-left"></i>Kembali</a>
          </div>
          <div class="card-body">
            <?php
        include "koneksi.php";
        $no=$_GET['no'];
        $datad = mysqli_query($koneksi,"select * from skpenelitian where no='$no'");
     ...
     <?php
        ...
        if(isset($_POST['edit']))
      {
       ...
       mysqli_query($koneksi,"update skpenelitian set 
        judul='$judul',
        pangkat='$pangkat',
        golongan='$golongan',
        hari='$hari',
        bulan='$bulan' where no='$no'");
