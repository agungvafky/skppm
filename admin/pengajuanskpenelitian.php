              ...
              <table class="table table-hover" id="dataTable" width="100%" cellspacing="0">
                ...
                <tbody align="center" valign="middle">
                  ...
                  <tr>
                    ...
                    <td>
                    <a href="buatskpenelitian.php?kode=<?php echo $data['kode']; ?>" class="btn btn-small text-success"><i class="fas fa-check-square"></i> </a>
                    <a href="tolakskpenelitian.php?kode=<?php echo $data['kode']; ?>" class="btn btn-small text-danger"><i class="fas fa-minus-square"></i></a>
                    </td>
                  </tr>
                  <?php $no++; } ?>
                </tbody>
