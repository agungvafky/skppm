...
$query = mysqli_query($koneksi,"select * from skpenelitian inner join dosen on skpenelitian.nidn=dosen.nidn where no='$no'");
$html = ' <html>
...
<p size="16px" align="justify">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Yang bertanda tangan dibawah ini adalah ketua Lembaga Penelitian dan Pengabdian Masyarakat (LP2M) 
Institut Agama Islam Negeri (IAIN) Bukittinggi, dengan ini menerangkan : </p>
...
<p size="16px" align="justify">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Demikian surat keterangan ini diberikan untuk dapat dipergunakan sebagaimana mestinya.</p>


<p size="16px" align="justify">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Bahwa yang bersangkutan telah melaksanakan judul penelitian "'.$row['judul'].'" pada setiap '.$row['hari'].'  bulan '.$row['bulan'].' '.$row['tahun'].'.</p>
